...
import com.app.motus_finance.data.dao.DueDatesDAO_Impl;
import com.app.motus_finance.data.dao.ExpensesDAO;
import com.app.motus_finance.data.dao.ExpensesDAO_Impl;
import com.app.motus_finance.data.dao.GraphicsDAO;
import com.app.motus_finance.data.dao.GraphicsDAO_Impl;
import com.app.motus_finance.data.dao.MarketDAO;
import com.app.motus_finance.data.dao.MarketDAO_Impl;
import com.app.motus_finance.data.dao.PaymentDAO;
import com.app.motus_finance.data.dao.PaymentDAO_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(5) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoMarketEntity.equals(_existingMarketEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "market_entity(com.app.motus_finance.data.models.Market).\n"
                  + " Expected:\n" + _infoMarketEntity + "\n"
        ...
        if (!_infoTableExpenses.equals(_existingTableExpenses)) {
          return new RoomOpenHelper.ValidationResult(false, "table_expenses(com.app.motus_finance.data.models.Expenses).\n"
                  + " Expected:\n" + _infoTableExpenses + "\n"
        ...
        if (!_infoPaymentTable.equals(_existingPaymentTable)) {
          return new RoomOpenHelper.ValidationResult(false, "payment_table(com.app.motus_finance.data.models.Payments).\n"
                  + " Expected:\n" + _infoPaymentTable + "\n"
        ...
        if (!_infoDueDateEntity.equals(_existingDueDateEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "dueDate_entity(com.app.motus_finance.data.models.DueDates).\n"
                  + " Expected:\n" + _infoDueDateEntity + "\n"
        ...
        if (!_infoGraphicsEntity.equals(_existingGraphicsEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "graphics_entity(com.app.motus_finance.data.models.Graphics).\n"
                  + " Expected:\n" + _infoGraphicsEntity + "\n"
